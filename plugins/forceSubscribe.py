      ...
      try:
        ...
        try:
          sent_message = message.reply_text(
              " {} , Non sei ancora iscritto al mio canale. Per favore, unisciti usando il bottone di sotto e premi il pulsante 'FATTO' per continuare a scrivere nel gruppo".format(message.from_user.mention, channel, channel),
