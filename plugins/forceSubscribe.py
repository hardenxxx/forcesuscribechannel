      ...
      try:
        ...
        try:
          sent_message = message.reply_text(
              " {}  Non sei ancora iscritto al mio canale. Per favore, unisciti usando il bottone qui sotto '⏩ Stream redirect ⏪'.dopo premi il pulsante 'FATTO'".format(message.from_user.mention, channel, channel),
              disable_web_page_preview=True,
             reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("⏩ Stream redirect ⏪", url=channel_url)
                ],
                [
